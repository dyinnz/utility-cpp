...
class BaseLogger {
  public:
    ...
    template<typename ...A> void log    (A... args) { print_wrapper (kLog, args...); }
    template<typename ...A> void notice (A... args) { print_wrapper (kNotice, args...); }
    template<typename ...A> void error  (A... args) { print_wrapper (kError, args...); }
